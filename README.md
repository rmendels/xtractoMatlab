...
To download either clone using Git, or just click on the button to download a zip of the files. Requires a version of Matlab that supports webread, websave and weboptions.  The file `vignette.m` contains code that executes all of the examples in the R <https://github.com/rmendels/xtractomatic>. <span style="color:blue">xtractomatic</span> package.
